...
<style>
    ...
    .flatpickr-day.endRange:hover {
        background: var(--pn-green) !important; border-color: var(--pn-green) !important;
    }
    .flatpickr-months .flatpickr-month {
        background: var(--pn-green) !important; color: #fff !important; fill: #fff !important;
    ...
    /* --- HEADER & CARD --- */
    .card-header-pn {
        background-color: var(--pn-green); color: white; border-bottom: 4px solid var(--pn-gold);
        padding: 15px 20px; display: flex; justify-content: space-between; align-items: center;
        border-radius: 10px 10px 0 0;
    }
    .page-header-title { 
        border-left: 5px solid var(--pn-gold); padding-left: 15px; color: var(--pn-green);
    ...
    .input-group-clean {
        ...
        border-radius: 8px; background-color: #fff; transition: all 0.3s ease;
        overflow: hidden; height: 48px; width: 100%; position: relative;
    }
    .input-group-clean:focus-within {
        border-color: var(--pn-green); box-shadow: 0 0 0 4px rgba(0, 77, 0, 0.1); transform: translateY(-1px);
    }
    .input-icon-clean {
        width: 45px; height: 100%; display: flex; align-items: center; justify-content: center;
        color: var(--pn-green); background-color: #f8f9fc; border-right: 1px solid #eaecf4;
        font-size: 1rem; flex-shrink: 0; 
    }
    .form-control-clean {
        flex: 1; border: none; height: 100%; width: 100%; padding: 0 15px; font-size: 0.95rem;
        color: #495057; background-color: #fff !important; outline: none;
    }
    ...
    <div class="row">
            ...
            <div class="card card-clean shadow-sm h-100">
                ...
                <div class="card-body p-4">
                    <form action="pages/proses_izin_pulang.php" method="POST" autocomplete="off">
                        ...
                        <div class="mb-3">
                            <label class="form-label-pn">Tanggal Pulang Awal <span class="text-danger">*</span></label>
                            <div class="input-group-clean">
                        ...
                        <div class="mb-4">
                            <label class="form-label-pn">Alasan Pulang Awal <span class="text-danger">*</span></label>
                            <div class="input-group-clean textarea-group">
                                <div class="input-icon-clean"><i class="fas fa-align-left"></i></div>
                                <textarea name="keperluan" class="form-control-clean" rows="2" placeholder="Contoh: Acara keluarga mendadak, Sakit, dll..." required></textarea>
                            </div>
                        </div>
        ...
        <div class="col-lg-7">
            <div class="card card-clean shadow-sm mb-4">
                <div class="card-header-pn">
                    <div class="font-weight-bold"><i class="fas fa-history mr-2"></i>Riwayat Pulang Awal</div>
                </div>
                <div class="card-body">
                        ...
                        <table class="table table-bordered table-hover" id="dataTableUser" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                ...
                                $q_riwayat = mysqli_query($koneksi, "SELECT i.*, a.nama_lengkap as atasan 
                                                                     ...
                                                                     ORDER BY i.id_izin_pulang DESC"); // Sesuaikan nama ID primary key
                                ...
                                <tr>
                                    ...
                                    <td class="text-center align-middle">
                                        <a href="pages/cetak_izin_pulang.php?id=<?= $row['id_izin_pulang']; ?>" target="_blank" class="btn-circle-action btn-print shadow-sm" title="Cetak Surat">
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Setup Jam Pulang (Bisa disesuaikan range jamnya)
        flatpickr(".flatpickr-time", {
            ...
            time_24hr: true,
            minTime: "08:00",
            maxTime: "17:00", // Bisa diubah jika lembur
            allowInput: false
        });
    ...
    $(document).ready(function() {
        $('#dataTableUser').DataTable({
            ...
            "ordering": false,
            "language": {
                "sEmptyTable":   "Belum ada riwayat izin pulang awal",
