                    ...
                    <div id="area_tabel_user">
                        <?php if(mysqli_num_rows($q_riwayat) == 0) { ?>
                            <div class="alert alert-light text-center border shadow-sm" style="border-radius: 12px;">
                                <h6 class="text-muted m-3"><i class="fas fa-info-circle mr-2"></i>Riwayat pulang awal tidak ditemukan.</h6>
                            </div>
                        <?php } else { ?>
    ...
    $(document).ready(function() {
        $('#keyword').on('keyup', function() {
            ...
            $('#area_tabel_user').load(
                'index.php?page=izin_pulang&cari=' + encodeURIComponent(keyword) + ' #area_tabel_user'
            );
        });
    });
